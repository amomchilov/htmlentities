...
class HTMLEntities
  ...
  #
  def decode(source, tolerate_forgotten_octothorpes: false)
    (@decoder ||= Decoder.new(@flavor, tolerate_forgotten_octothorpes: tolerate_forgotten_octothorpes)).decode(source)
  end
